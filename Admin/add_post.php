      ...
      <section class="wrapper">
        ...
        <div class="container row">
              ...
              if(isset($_POST['add_news']) && $_FILES['post_image'] !== "" && $_FILES['post_image'] !== " ") {
                ...
                if (!in_array($fileActualExt, $allowed)) {
                 ...
                 elseif ($_POST['content']=="") {
                  $err_msg['content'] ="Content is required";
                }
                elseif ($_POST['tags']=="") {
                  $err_msg['tags'] ="Tags are required";
                }
                else {
                    if($imageSize > 10000000) {
                      header("Location: add_post.php?message=file_is_large");
                        ...
                        $post_obj->addNews($_POST['title'], $_POST['content'], $_POST['category'],$_POST['type_news'], $_POST['tags'], $target_file);
                      header("Location: post.php?message=post_added");
                    }
                }
              }
          ...
          <form method="POST" action="" role="form" class="col-lg-8" autocomplete="off" runat="server" enctype="multipart/form-data">
            <h3>Add News</h3>
               <?php
                if(isset($err_msg['title'])){
                  echo "<div style='color:#cc0000;padding-top:5px;float:left;width:100%;'>".$err_msg['title']."</div>";
                } 
              ?>
            <div class="form-group">
              ...
              <span class="input-group-addon" id="left">60</span>
               ...
               <?php
                if(isset($err_msg['content'])){
                  echo "<div style='color:#cc0000;padding-top:5px;float:left;width:100%;'>".$err_msg['content']."</div>";
                } 
              ?>
             <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" name="tags" placeholder="News Tags (seperate by a comma)" class="form-control">
                <?php
                if(isset($err_msg['tags'])){
                  echo "<div style='color:#cc0000;padding-top:5px;float:left;width:100%;'>".$err_msg['tags']."</div>";
                } 
              ?>
            </div>
            <div class="form-group">
