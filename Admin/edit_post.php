      ...
      <section class="wrapper">
        ...
        <div class="container row">
            ...
            $role = $user_obj->getRole();
             if(isset($_GET['pos_id']) && $_GET['pos_id'] !== "" && $role === 'Admin') {
                $pos_id = $_GET['pos_id'];
                ...
                if (!in_array($fileActualExt, $allowed)) {
                  header("Location: edit_post.php?message=file_type_not_allowed");
                } elseif ($_POST['utitle'] == "") {
                ...
                elseif ($_POST['utags']=="") {
                  $err_msg['utags'] ="Tags are required";
                    ...
                    if($imageSize > 10000000) {
                      header("Location:edit_post.php?message=file_is_large");
                    } else {
                        $fileNewName = uniqid('',true) . "." . $fileActualExt;
                        $dir = "news_images/";
                        $target_file = $dir . basename($fileNewName);
                        move_uploaded_file($fileTmpName, $target_file);
                        $post_obj->updatePost($pos_id, $_POST['utitle'],$_POST['ucontent'],$_POST['ucategory'],$_POST['utype_news'],$_POST['utags'],$target_file);
